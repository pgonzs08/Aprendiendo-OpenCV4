...
#La función imwrite requiere consistencia con el formato en el que se quiere guardar la imágen
#Por ejemplo bmp requiere 8bits por canal, mientras que png permite tanto 8 como 16 bits
